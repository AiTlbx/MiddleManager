...
public static class SidecarProtocol
{
    ...
    public static byte[] CreateCreateSessionPayload(CreateSessionRequest request)
    {
    ...
    public static CreateSessionRequest ParseCreateSessionPayload(ReadOnlySpan<byte> payload)
    {
