...
namespace Ai.Tlbx.MiddleManager.Ipc.Unix;
...
public sealed class UnixSocketTransport : IIpcTransport
{
    ...
    public bool IsConnected => _socket?.Connected == true && !_disposed;
...
public sealed class UnixSocketServer : IIpcServer
{
    ...
    {
        _socketPath = socketPath ?? UnixSocketTransport.DefaultSocketPath;
    }
    ...
    public async Task<IIpcTransport> AcceptAsync(CancellationToken cancellationToken = default)
    {
        ...
        return new UnixSocketServerTransport(clientSocket);
    }
...
internal sealed class UnixSocketServerTransport : IIpcTransport
{
    ...
    public UnixSocketServerTransport(Socket socket)
    {
        _socket = socket;
